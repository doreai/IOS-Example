...
class Videocartoon: UIViewController {
    ...
    func run_segment(_ inputImage: UIImage ) {
        ...
        let ciImage:UIImage = result.GeneratedImage(Width: Int(inputImage.size.width), Height: Int(inputImage.size.height) )
...
extension Videocartoon: UIImagePickerControllerDelegate,UINavigationControllerDelegate {
