...
install_xcframework "${PODS_ROOT}/DorePetSegmentLite/Frameworks/DorePetSegmentLite.xcframework" "DorePetSegmentLite" "framework" "ios-x86_64-simulator" "ios-arm64_arm64e"
